...
public class DiamondEconomy implements ModInitializer {
    ...
    public static void initServer(MinecraftServer server) {
        DiamondUtils.registerTable("CREATE TABLE IF NOT EXISTS diamonds (uuid text PRIMARY KEY, name text NOT NULL, money integer DEFAULT 0, taxlevel integer DEFAULT 1);");
